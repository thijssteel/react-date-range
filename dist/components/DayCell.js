...
var DayCell = function (_PureComponent) {
  _inherits(DayCell, _PureComponent);
  ...
  _createClass(DayCell, [{
    ...
    value: function renderSelectionPlaceholders() {
      ...
      if (this.props.displayMode === 'multiDate') {
        var _isSelected = this.props.dates.some(function (date) {
          return (0, _isSameDay2.default)(_this2.props.day, date);
        });
        return _isSelected ? _react2.default.createElement('span', { className: styles.selected, style: { color: this.props.color } }) : null;
      }
...
DayCell.propTypes = {
  ...
  color: _propTypes2.default.string,
  displayMode: _propTypes2.default.oneOf(['dateRange', 'date', 'multiDate']),
